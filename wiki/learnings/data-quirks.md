...
## ⚠️ 1988→1989 Metric Switch Discontinuity (births-data.json)

**The single biggest data quality issue in the births visualization.**
...
**Status:** See `wiki/vision/births-choropleth.md` for proposed solutions.
